...
public class KafkaProducer {
    public static void main(String[] args) {
		 ...
		 */
        props.put("partitioner.class", "kafka.patition.MyPatition");
        ...
        for (int i =1;i<=100000;i++) {
            ...
            String msg = UUID.randomUUID().toString() + "--" + i + "_Test_Kafaka";
            producer.send(new KeyedMessage<String,String>(topic,i+"",msg));
